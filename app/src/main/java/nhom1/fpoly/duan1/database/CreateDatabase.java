...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insert_product = "insert into Products values " +
                ...
                "(1, 0, 'Trà sữa chân châu đường đen', 'Trà sữa trân châu đường đen được yêu thích nhờ sự kết hợp hết sức hoàn hảo giữa vị trà sữa thơm béo và trân châu đường đen mềm, ngọt.', 'https://salt.tikicdn.com/cache/750x750/ts/product/17/90/cf/e2a74e5309f173ad0ad766ce962863cc.jpg.webp', 25000), " +
