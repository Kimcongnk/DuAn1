...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insert_product = "insert into Products values " +
                ...
                "(1, 1, 'Trà sữa chân châu đường đen', 'Trà sữa trân châu đường đen được yêu thích nhờ sự kết hợp hết sức hoàn hảo giữa vị trà sữa thơm béo và trân châu đường đen mềm, ngọt.', 'https://salt.tikicdn.com/cache/750x750/ts/product/17/90/cf/e2a74e5309f173ad0ad766ce962863cc.jpg.webp', 25000), " +
                "(2,2, 'Sting', 'Sting là sản phẩm nước tăng lực với mùi vị thơm ngon, sảng khoái. Nước tăng lực Sting giúp cơ thể bù đắp nước, bổ sung năng lượng, vitamin C và E, giúp xua tan cơn khát và cảm giác mệt mỏi.', 'https://bizweb.dktcdn.net/thumb/large/100/469/765/products/nuoc-tang-luc-sting-huong-dau-330ml-201909031559004919.jpg', 10000), " +
                ...
                "(5,2, 'Pepsi', 'Thức uống có gas Pepsi có hương vị lôi cuốn, vị ngọt nhẹ, không gắt, mang đến cảm giác sảng khoái trong những ngày hè nóng bức và sau những giờ hoạt động mạnh.', 'https://product.hstatic.net/1000141988/product/nuoc_ngot_pepsi_36daafe416c7499aacd53694c72ef692_1024x1024.jpg', 10000)";
