...
//        img_select = (ImageView) view.findViewById(R.id.img_select);
    ...
    private void themSP(int id_Loai,String imagePath ){
        ...
        product.setImg_product(imagePath);
        product.setDesc_product(desc);
        String checkProduct = "Còn hàng";
        boolean check = productsDao.themProduct(name, imagePath, id_Loai, price, desc, checkProduct);
        if (check) {
